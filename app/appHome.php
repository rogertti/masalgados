                    ...
                    <div class="box">
                        ...
                        <?php
                            ...
                            try {
                                ...
                                $datado = $ano.'-'.$mes.'%';
                                $monitor = 'T';
                                #$sql = $pdo->prepare("SELECT pedido.idpedido,pedido.codigo,pedido.tipo,pedido.datado,pedido.hora,pedido.forma_pagamento,vendedor.nome AS vendedor,cliente.nome AS cliente FROM pedido INNER JOIN vendedor ON pedido.vendedor_idvendedor = vendedor.idvendedor INNER JOIN cliente ON pedido.cliente_idcliente = cliente.idcliente WHERE pedido.monitor = :monitor AND vendedor.idvendedor = :idvendedor ORDER BY pedido.tipo,pedido.datado,pedido.hora,vendedor.nome,cliente.nome");
                                $sql = $pdo->prepare("SELECT pedido.idpedido,pedido.codigo,pedido.tipo,pedido.datado,pedido.hora,pedido.forma_pagamento,vendedor.nome AS vendedor,cliente.nome AS cliente FROM pedido INNER JOIN vendedor ON pedido.vendedor_idvendedor = vendedor.idvendedor INNER JOIN cliente ON pedido.cliente_idcliente = cliente.idcliente WHERE pedido.datado LIKE :datado AND pedido.monitor = :monitor AND vendedor.idvendedor = :idvendedor ORDER BY pedido.tipo,pedido.datado,pedido.hora,vendedor.nome,cliente.nome");
                                            ...
                                            while($lin = $sql->fetch(PDO::FETCH_OBJ)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-action">
                                                        ...
                                                        <span class="label label-warning"><a class="text-white" data-toggle="modal" data-target="#modal-edit-pedido" title="Editar o pedido" href="pedidoEdit.php?'.$py.'='.$lin->idpedido.'"><i class="fa fa-pencil fa-lg"></i></a></span>
                                                        <span class="label label-danger"><a class="text-white a-delete-pedido" id="'.$py.'-'.$lin->idpedido.'" title="Excluir o pedido" href="#"><i class="fa fa-trash-o fa-lg"></i></a></span>
                                                    </td>
                                                </tr>';
                                        ...
                                        echo'
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th>Cliente</th>
                                                    <th>Forma de pagamento</th>
                                                    <th><button type="button" class="btn btn-flat btn-success btn-box-print hide">Imprimir selecionados</button></th>
                                                </tr>
                                            </tfoot>
                                        </table>';
                                                    ...
                                                    $ret2 = $sql2->rowCount();
                                                        ...
                                                        if($ret2 > 0) {
                                                            while($lin2 = $sql2->fetch(PDO::FETCH_OBJ)) {
                                                                if($lin2->idvendedor == $_SESSION['id']) {
                                                                    echo'
